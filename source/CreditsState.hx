...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Week D'],
		['vullen',				'vullen',			'cat',												'https://twitter.com/vuwwen',			0xFF34243D],
		['HushPuppy',			'hushpuppy',		'Song Mastering, Rad Lad',							'https://twitter.com/Hushpuppymusic',	0xFFC37F30],
		[''],
		['Psych Engine Team'],
		...
		['bubba',				'bubba',			'Guest Composer for "Hot Dilf"',					'https://www.youtube.com/bubbabrine11',	0xFF61536A],
		[''],
		["Funkin' Crew"],
